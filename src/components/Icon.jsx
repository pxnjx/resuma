// ─────────────────────────────────────────────────────────────
//  Central SVG icon registry (stroke-based, 24×24 viewBox).
//  Every icon/symbol used across the app lives here — pages only
//  reference them by name via <Icon name="..." />, never raw SVG
//  or emoji written directly in the markup.
//  Usage: <Icon name="trash-2" size={16} />
// ─────────────────────────────────────────────────────────────
...
const ICONS = {
  ...
  'map-pin': (
    <>
      <path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.986 0C10.723 19.905 12 14.99 12 10a8 8 0 1 1 16 0Z" />
